...
import AddWiggRetro from '../AddWiggRetro';
...
describe('AddWiggRetro', () => {
  ...
  it('shows login prompt for unauthenticated users', () => {
    ...
    expect(getByText('Please log in to create WIGG ratings')).toBeInTheDocument();
  ...
  it('renders media search for authenticated users', () => {
    ...
    expect(getByText('Retrospective Rating')).toBeInTheDocument();
